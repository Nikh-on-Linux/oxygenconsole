...
function FolderBox({ foldername = "Sample Folder", folderid }: { foldername?: String, folderid?: String }) {
  ...
  return (
    <div onClick={() => {router.push(folderpath) }} className='max-w-42 hover:border-foreground/20 overflow-hidden transition-all duration-200 select-none relative px-4 py-4 aspect-square w-full bg-card rounded-xl border border-border/50' >
